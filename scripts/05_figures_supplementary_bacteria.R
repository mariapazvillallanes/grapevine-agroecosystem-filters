...
# Purpose:
#   Generate supplementary figures for culturable bacteria:
#   - Fig S1: Isolation success (N) vs alpha diversity (Richness, Shannon)
#   - Fig S2: Alpha diversity across organs, faceted by Management
#   - Fig S3: PCoA (Bray–Curtis) on relative abundances
#
# Inputs (generated by scripts/02_bacteria_analysis.R):
#   outputs/objects/bacteria_meta.rds
#   outputs/objects/bacteria_matrix_counts.rds
#
# Outputs (not tracked by git; outputs/ is ignored):
#   outputs/figures/supplementary/FigS1_N_vs_Alpha_Bacteria.pdf
#   outputs/figures/supplementary/FigS2_Alpha_Boxplots_Bacteria.pdf
#   outputs/figures/supplementary/FigS3_PCoA_BrayCurtis_Bacteria.pdf
# ======================================================================
...
# ---- Load saved objects ----
meta <- readRDS("outputs/objects/bacteria_meta.rds")
X_counts <- readRDS("outputs/objects/bacteria_matrix_counts.rds")
...
ggsave("outputs/figures/supplementary/FigS1_N_vs_Alpha_Bacteria.pdf",
...
ggsave("outputs/figures/supplementary/FigS2_Alpha_Boxplots_Bacteria.pdf",
...
ggsave("outputs/figures/supplementary/FigS3_PCoA_BrayCurtis_Bacteria.pdf",
       p_S3, width = 7.2, height = 5.2, device = cairo_pdf)

message("Supplementary bacteria figures exported to outputs/figures/supplementary/")
